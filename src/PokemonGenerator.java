  ...
  */
  public Pokemon getPokemon(String name){ //beginning of getPokemon
    ...
    switch (pokemon.get(name)) {
      case "Fire" -> constructedPokemon = new Fire(name, randHP, randHP);
      case "Water" -> constructedPokemon = new Water(name, randHP, randHP);
      case "Grass" -> constructedPokemon = new Grass(name, randHP, randHP);
    }
